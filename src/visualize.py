...
from .preliminary_tests import RV, DiscreteRV
...
def get_pseudo_density(rv: DiscreteRV, kernel: str="gaussian") -> Tuple[np.ndarray, np.ndarray]:
...
def plot_cdf(rv: DiscreteRV) -> List["Line2D"]:
